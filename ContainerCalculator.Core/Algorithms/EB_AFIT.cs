...
namespace ContainerCalculator.Core.Algorithms
{
	public class EB_AFIT:IPackingAlgorithm
	{
		...
		public AlgorithmPackingResult Run(Container container, List<Item> items)
		{
			...
			AlgorithmPackingResult result = new AlgorithmPackingResult {AlgorithmID = (int) AlgorithmType.EB_AFIT, AlgorithmName = "EB-AFIT"};
